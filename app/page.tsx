          ...
          <div className="container">
            <div className="grid items-center gap-14 hero-grid grid-cols-[1.04fr_1.06fr]">
              ...
              <div>
                ...
                <h1 className="display mt-[20px]"> {h.hero.titleLine1}<br /> <span className="text-brand-700">{h.hero.titleLine2}</span> </h1>
                <p className="lead mt-[22px] max-w-[520px]"> {h.hero.lead} </p>
              ...
              <div className="hero-mock relative">
                <div className="card rounded-[22px] overflow-hidden shadow-lg">
                  ...
                  <div className="flex items-center gap-[8px] py-[12px] px-[16px] bg-cream border-b border-solid border-line-2">
                    ...
                    <span className="ml-[10px] flex-1 bg-white border border-solid border-line-2 rounded-[8px] py-[5px] px-[12px] text-[11.5px] text-muted" style={{ fontFamily: "'DM Mono',monospace" }}>{h.mock.url}</span>
                  </div>
                  {/* storefront body */}
                  <div className="bg-white">
                    <div className="flex items-center justify-between py-[14px] px-[18px] border-b border-solid border-line">
                      <span className="font-extrabold text-[15px] tracking-[-.02em]">{h.mock.hotel}</span>
                      <span className="flex gap-[14px] text-[12px] text-muted">
                        <span>{h.mock.navRooms}</span>
                        <span>{h.mock.navAmenities}</span>
                        <span>{h.mock.navContact}</span>
                      </span>
                    </div>
                    <Placeholder label={h.mock.lobbyPhoto} className="h-[150px]" />
                    {/* booking widget */}
                    <div className="mt-[-26px] mx-[16px] relative bg-white border border-solid border-line-2 rounded-[14px] shadow p-[14px] grid grid-cols-[1fr_1fr_auto] gap-[10px] items-end">
                      <div>
                        <div className="text-[10.5px] text-muted mb-[4px]">{h.mock.checkIn}</div>
                        <div className="text-[12.5px] font-bold">{h.mock.checkInDate}</div>
                      </div>
                      <div>
                        <div className="text-[10.5px] text-muted mb-[4px]">{h.mock.checkOut}</div>
                        <div className="text-[12.5px] font-bold">{h.mock.checkOutDate}</div>
                      </div>
                      <div className="bg-brand-600 text-white rounded-[10px] py-[9px] px-[14px] text-[12.5px] font-bold">{h.mock.search}</div>
                    </div>
                    {/* room cards */}
                    <div className="grid grid-cols-[1fr_1fr] gap-[12px] p-[16px]">
                      <div className="border border-solid border-line rounded-[12px] overflow-hidden">
                        <Placeholder label={h.mock.deluxePhoto} className="h-[62px]" labelStyle={{ fontSize: "10px" }} />
                        <div className="py-[9px] px-[11px]">
                          <div className="text-[12px] font-bold">{h.mock.deluxeName}</div>
                          <div className="text-[11px] text-brand-700 font-bold mt-[3px]">{h.mock.deluxePrice}</div>
                        </div>
                      </div>
                      <div className="border border-solid border-line rounded-[12px] overflow-hidden">
                        <Placeholder label={h.mock.suitePhoto} className="h-[62px]" labelStyle={{ fontSize: "10px" }} />
                        <div className="py-[9px] px-[11px]">
                          <div className="text-[12px] font-bold">{h.mock.suiteName}</div>
                          <div className="text-[11px] text-brand-700 font-bold mt-[3px]">{h.mock.suitePrice}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card float-a absolute bottom-[-22px] left-[-22px] py-[13px] px-[16px] flex items-center gap-[11px] shadow-lg">
                  ...
                  <div>
                    <div className="text-[12px] text-muted">{h.mock.newBooking}</div>
                    <div className="text-[13.5px] font-extrabold">{h.mock.newBookingDetail}</div>
                  </div>
                </div>
                <div className="card float-b absolute top-[34px] right-[-26px] py-[12px] px-[15px] shadow-lg">
                  <div className="text-[11.5px] text-muted">{h.mock.directBookings}</div>
                  <div className="flex items-baseline gap-[6px]">
                    <span className="stat-num text-[26px] text-brand-700">+38%</span>
                    <span className="text-[11px] text-[#2f8f5b] font-bold">{h.mock.growth}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="border-y border-solid border-line bg-white">
          <div className="container py-[34px]">
            <div className="grid items-center gap-8 trust-row grid-cols-[auto_1fr]">
              <div className="text-[13.5px] text-muted max-w-[170px] leading-[1.6]">{h.trust.label}</div>
              <div className="trust-logos flex flex-wrap items-center gap-x-[30px] gap-y-[14px] justify-end">
                {[0, 1, 2, 3, 4].map((i) => (
                  <Placeholder key={i} label={h.trust.logo} className="h-[32px] w-[118px] rounded-[8px]" labelStyle={{ fontSize: "9.5px" }} />
                ))}
              </div>
            </div>
        ...
        <section className="section">
          <div className="container">
            <div className="reveal max-w-[680px] mb-[48px]">
              ...
              <h2 className="display mt-[16px]" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.features.title}</h2>
              <p className="lead mt-[16px]">{h.features.lead}</p>
            </div>
            ...
            <div className="reveal mt-[30px]">
              <Button asChild variant="ghost"><LocalizedLink href={ROUTES.FEATURES}>{h.features.exploreAll} {ArrowIcon}</LocalizedLink></Button>
            </div>
          </div>
        </section>
        {/* ============== HOW IT WORKS ============== */}
        <section className="section bg-cream">
          <div className="container">
            <div className="reveal text-center max-w-[640px] mx-auto mb-[52px]">
              <Eyebrow center>{h.how.eyebrow}</Eyebrow>
              <h2 className="display mt-[16px]" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.how.title}</h2>
            </div>
          ...
          <div className="container">
            <div className="reveal flex items-end justify-between flex-wrap gap-4 mb-[44px]">
              <div className="max-w-[560px]">
                <Eyebrow>{h.gallery.eyebrow}</Eyebrow>
                <h2 className="display mt-[16px]" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.gallery.title}</h2>
                <p className="lead mt-[14px]">{h.gallery.lead}</p>
              </div>
          ...
          <div className="container">
            <div className="grid items-center gap-12 dash-grid grid-cols-[1fr_1.15fr]">
              <div className="reveal">
                <Eyebrow className="text-brand-300">{h.dash.eyebrow}</Eyebrow>
                <h2 className="display mt-[16px] text-white" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.dash.title}</h2>
                <p className="mt-[16px] text-[#a8c0ba] text-[17px] leading-[1.8] max-w-[480px]">{h.dash.lead}</p>
                <ul className="list-none p-0 mt-[26px] flex flex-col gap-[14px]">
                  {h.dash.bullets.map((b) => (
                ...
                <Button asChild variant="soft" className="mt-[28px]"><LocalizedLink href={ROUTES.FEATURES}>{h.dash.explore}</LocalizedLink></Button>
              </div>
              <div className="reveal">
                <div className="bg-white rounded-[18px] shadow-lg overflow-hidden">
                  <div className="flex items-center justify-between py-[14px] px-[18px] border-b border-solid border-line">
                    <div className="flex items-center gap-[9px]">
                      ...
                      <span className="font-extrabold text-[14px]">{h.dash.panelTitle}</span>
                    </div>
                    <Chip variant="sand" className="text-[11px]">{h.dash.activeProps}</Chip>
                  </div>
                  <div className="p-[18px]">
                    <div className="grid gap-3 grid-cols-3">
                      <div className="bg-paper border border-solid border-line rounded-[12px] p-[13px]">
                        <div className="text-[11px] text-muted">{h.dash.occupancy}</div>
                        <div className="stat-num text-[26px] text-brand-700 mt-[4px]">82%</div>
                      </div>
                      <div className="bg-paper border border-solid border-line rounded-[12px] p-[13px]">
                        <div className="text-[11px] text-muted">{h.dash.todayRevenue}</div>
                        <div className="stat-num text-[26px] text-ink mt-[4px]">$9.4k</div>
                      </div>
                      <div className="bg-paper border border-solid border-line rounded-[12px] p-[13px]">
                        <div className="text-[11px] text-muted">{h.dash.upcoming}</div>
                    ...
                    <div className="bg-paper border border-solid border-line rounded-[12px] p-[16px] mt-[12px]">
                      <div className="flex items-center justify-between mb-[14px]">
                        <span className="text-[13px] font-bold">{h.dash.revenue7d}</span>
        ...
        <section className="section">
          <div className="container">
            <div className="reveal text-center max-w-[600px] mx-auto mb-[50px]">
              <Eyebrow center>{h.testimonials.eyebrow}</Eyebrow>
              <h2 className="display mt-[16px]" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.testimonials.title}</h2>
            </div>
        ...
        <section className="section bg-cream">
          <div className="container">
            <div className="reveal text-center max-w-[600px] mx-auto mb-[48px]">
              ...
              <h2 className="display mt-[16px]" style={{ fontSize: "clamp(28px,3.6vw,44px)" }}>{h.pricing.title}</h2>
              <p className="lead mt-[14px]">{h.pricing.lead}</p>
            </div>
            <div className="grid gap-5 price-grid grid-cols-3 items-stretch">
              <div className="card reveal p-[30px] flex flex-col">
                <h3 className="text-[18px]">{h.pricing.basic.name}</h3>
                <p className="text-muted text-[13.5px] mt-[6px]">{h.pricing.basic.desc}</p>
                <div className="mt-[18px] mb-[4px]">
                  <span className="stat-num text-[40px] text-ink">{h.pricing.basic.price}</span>
                  <span className="text-[13px] text-muted">{h.pricing.basic.per}</span>
                </div>
                <hr className="hairline my-[18px]" />
                <ul className="list-none p-0 m-0 flex flex-col gap-[11px] text-[14px] text-ink-700">
                  {h.pricing.basic.features.map((f) => <li key={f}>{f}</li>)}
                </ul>
                <Button asChild variant="outline" className="mt-[24px]"><LocalizedLink href={ROUTES.PRICING}>{h.pricing.basic.cta}</LocalizedLink></Button>
              </div>
              <div className="card reveal p-[30px] flex flex-col border-[1.5px] border-solid border-brand-600 shadow-lg relative">
                <Chip className="absolute top-[-13px] left-[30px] bg-brand-600 text-white border-brand-600">{h.pricing.pro.badge}</Chip>
                <h3 className="text-[18px] text-brand-700">{h.pricing.pro.name}</h3>
                <p className="text-muted text-[13.5px] mt-[6px]">{h.pricing.pro.desc}</p>
                <div className="mt-[18px] mb-[4px]">
                  <span className="stat-num text-[40px] text-brand-700">{h.pricing.pro.price}</span>
                  <span className="text-[13px] text-muted">{h.pricing.pro.per}</span>
                </div>
                <hr className="hairline my-[18px]" />
                <ul className="list-none p-0 m-0 flex flex-col gap-[11px] text-[14px] text-ink-700">
                  {h.pricing.pro.features.map((f) => <li key={f}>{f}</li>)}
                </ul>
                <Button asChild className="mt-[24px]"><LocalizedLink href={ROUTES.PRICING}>{h.pricing.pro.cta}</LocalizedLink></Button>
              </div>
              <div className="card reveal p-[30px] flex flex-col">
                <h3 className="text-[18px]">{h.pricing.enterprise.name}</h3>
                <p className="text-muted text-[13.5px] mt-[6px]">{h.pricing.enterprise.desc}</p>
                <div className="mt-[18px] mb-[4px]">
                  <span className="stat-num text-[34px] text-ink">{h.pricing.enterprise.price}</span>
                </div>
                <hr className="hairline my-[18px]" />
                <ul className="list-none p-0 m-0 flex flex-col gap-[11px] text-[14px] text-ink-700">
                  {h.pricing.enterprise.features.map((f) => <li key={f}>{f}</li>)}
                </ul>
                <Button asChild variant="dark" className="mt-[24px]"><LocalizedLink href={ROUTES.CONTACT}>{h.pricing.enterprise.cta}</LocalizedLink></Button>
              </div>
            </div>
            <div className="reveal text-center mt-[28px]">
              <Button asChild variant="ghost"><LocalizedLink href={ROUTES.PRICING}>{h.pricing.compareAll} {ArrowIcon}</LocalizedLink></Button>
            </div>
          </div>
        </section>
        {/* ============== FINAL CTA ============== */}
