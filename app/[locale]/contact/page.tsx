            ...
            <div className="reveal">
              ...
              <div className="flex flex-col gap-[18px] mt-[34px]">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-bold text-[15px]">{t("contact.emailLabel")}</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-bold text-[15px]">{t("contact.phoneLabel")}</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-bold text-[15px]">{t("contact.officeLabel")}</div>
              ...
              <div className="card mt-[30px] p-[22px] flex items-center justify-between gap-[16px] bg-cream border-line-2">
                <div>
                  <div className="font-bold text-[15.5px]">{t("contact.bookTitle")}</div>
                  <div className="text-muted text-[13.5px] mt-[3px]">
                    {t("contact.bookDesc")}
                  </div>
                </div>
                <Button asChild variant="outline" className="flex-none">
                  <a href={EXTERNAL.BOOK_MEETING}>{t("contact.bookCta")}</a>
                </Button>
              </div>
            </div>
